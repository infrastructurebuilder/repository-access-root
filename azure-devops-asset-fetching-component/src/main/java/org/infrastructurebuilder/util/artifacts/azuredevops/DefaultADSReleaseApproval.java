...
public class DefaultADSReleaseApproval extends AbstractIdentifiedNamedDescribedUrldOwned<ADSRelease>
  ...
  private final ADSReleaseDefinitionShallowReference releaseDefinition;
  private final ADSReleaseEnvironment releaseEnvironment;
  private final int revision;
  private final ADSApprovalStatus status;
  private final List<ADSReleaseApprovalHistory> history;
